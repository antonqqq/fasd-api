...
for c in contour_list:
    ...
    cv2.putText(image, "{:.2f}in".format(l_size), lxy[1], cv2.FONT_HERSHEY_SIMPLEX, 0.65, (255, 255, 255), 2)
    ...
    cv2.putText(image, "{:.2f}in".format(r_size), rxy[1], cv2.FONT_HERSHEY_SIMPLEX, 0.65, (255, 255, 255), 2)
    ...
    print(circularity)
    cv2.putText(image, "{:.2f}in".format(circularity), (shape[54][0], shape[54][1]), cv2.FONT_HERSHEY_SIMPLEX, 0.65, (255, 255, 255), 2)
